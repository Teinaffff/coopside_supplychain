...
export const manufacturerFormSchema = z.object({
  ...
  // factoryAddresses: z.array(addressSchema,
  ...
  productionLines: z.array(z.string()).default([]).optional(),
  machineryList: z.array(z.string()).default([]).optional(),
  rawMaterialSources: z.array(z.string()).default([]).optional(),
  ...
  suppliers: z.array(z.string()).default([]).optional(),
  distributors: z.array(z.string()).default([]).optional(),
  exportImportLicenses: z.array(z.string()).default([]).optional(),
