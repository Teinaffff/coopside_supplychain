...
export const manufacturersMockData = [
  {
    ...
    operatingLicenses: ["Manufacturing License ML-001", "Environmental Permit EP-001"],
    certifications: ["ISO 9001", "OEKO-TEX Standard 100"],
    mainProducts: ["Cotton Fabrics", "Synthetic Textiles", "Industrial Textiles"],
    productionCapacity: "500 tons/month",
    productionLines: ["Cotton Processing Line", "Synthetic Fiber Line", "Dyeing Line"],
  ...
  },
  {
    ...
    operatingLicenses: ["Heavy Industry License HIL-002", "Environmental Permit EP-002"],
    certifications: ["ISO 14001", "OHSAS 18001"],
    mainProducts: ["Construction Steel", "Industrial Steel", "Reinforcement Bars"],
    productionCapacity: "1000 tons/month",
    productionLines: ["Steel Rolling Line", "Bar Production Line", "Quality Control Line"],
    ...
    suppliers: ["Ethiopian Mining Corporation", "International Steel Suppliers"],
    distributors: ["Construction Material Distributors", "Industrial Supply Chain"],
  ...
  },
  {
    ...
    operatingLicenses: ["Cement Production License CPL-003", "Mining License ML-003"],
    certifications: ["ISO 9001", "ISO 14001", "CE Marking"],
    mainProducts: ["Portland Cement", "Blended Cement", "Special Purpose Cement"],
    productionCapacity: "2000 tons/day",
    productionLines: ["Clinker Production Line", "Cement Grinding Line", "Packaging Line"],
    machineryList: ["Rotary Kilns", "Ball Mills", "Packaging Machines"],
    rawMaterialSources: ["Local Limestone Quarry", "Clay Deposits", "Gypsum Suppliers"],
    ...
    distributors: ["Construction Supply Network", "Regional Building Materials"],
