...
export const superAdminStatsData = [
  {
    title: "Total Users",
    value: "2,847",
    change: 12,
...
export const superAdminRecentActivities = [
  {
    ...
    title: "New Institution: Addis Ababa University",
    description: "University registration completed and approved",
    timestamp: "2025-01-20T10:30:00Z",
    status: "completed",
    priority: "high",
    ...
    targetId: "inst_101",
    details: { institutionType: "University", employeeCount: 2500 },
  },
  {
    id: "2",
    type: "Agent Onboarding",
    title: "Agent Registration: Dawit Tesfaye",
    description: "New sales agent added to the system",
    timestamp: "2025-01-20T09:15:00Z",
    status: "pending",
    priority: "medium",
    category: "Agent",
    ...
    targetEntity: "Agent",
    targetId: "agent_001",
    details: { agentType: "Sales", region: "Addis Ababa" },
  },
  {
    id: "3",
    ...
    performedBy: "System",
    targetEntity: "Database",
    details: { duration: "45 minutes", impact: "Minimal" },
  },
  {
    id: "4",
    type: "Security Alert",
    ...
    targetEntity: "User",
    details: { attemptCount: 5, ipAddress: "203.0.113.45" },
  },
  {
    id: "5",
    type: "Data Export",
    title: "Monthly Report Generation",
    description: "System-wide monthly report generated",
    timestamp: "2025-01-19T14:20:00Z",
    status: "completed",
    priority: "medium",
    category: "Reports",
    performedBy: "Report Manager",
    targetEntity: "Report",
    details: { recordCount: 12500, fileSize: "15.2 MB" },
  },
];
...
export const systemMetricsData = {
  userGrowth: [
    ...
    { month: "Feb", current: 1350, previous: 1200 },
    { month: "Mar", current: 1500, previous: 1300 },
    { month: "Apr", current: 1650, previous: 1400 },
    { month: "May", current: 1800, previous: 1500 },
    { month: "Jun", current: 2000, previous: 1650 },
    { month: "Jul", current: 2150, previous: 1800 },
    { month: "Aug", current: 2300, previous: 1900 },
    { month: "Sep", current: 2450, previous: 2050 },
    { month: "Oct", current: 2600, previous: 2200 },
    { month: "Nov", current: 2750, previous: 2350 },
    { month: "Dec", current: 2847, previous: 2500 },
  ],
  entityDistribution: [
    { type: "Agents", count: 10, percentage: 45.5 },
    { type: "Consumers", count: 5, percentage: 22.7 },
    { type: "Institutions", count: 4, percentage: 18.2 },
    { type: "Manufacturers", count: 3, percentage: 13.6 },
  ],
  loanMonitoring: [
    { status: "Approved", count: 45, amount: 2500000 },
    { status: "Pending", count: 23, amount: 1200000 },
    { status: "Disbursed", count: 38, amount: 1800000 },
    { status: "Overdue", count: 8, amount: 450000 },
    { status: "Rejected", count: 12, amount: 600000 },
  ],
};
