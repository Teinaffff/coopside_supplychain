...
import { AddManufacturiesModal } from "./components/AddManufacturiesModal";
import { EditManufacturiesModal } from "./components/EditManufacturiesModal";
import ExportMembersDataToExcel from "./components/ExportMembersDataToExcel";
import { columns } from "./components/columns";

const ManufacturiessPage = () => {
  ...
  return (
    <>
      <AddManufacturiesModal />
      <EditManufacturiesModal />
      ...
      <Card className="p-5">
        <div className="flex border-b pb-2 items-center justify-between">
          <Heading
            title={`Manufacturies (${formattedMembers.length})`}
            description="Manage Manufacturies"
          />
          <div></div>
          <div>
            <Button
...
export default ManufacturiessPage;
