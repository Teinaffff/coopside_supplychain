...
import { ExportConsumersDataToExcel } from "./components/ExportConsumersDataToExcel";
              ...
              <Button
                onClick={() => {
                  if (consumers.length > 0) {
                    ExportConsumersDataToExcel(consumers, inferredInstitutionName);
                  } else {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={() => {
                if (consumers.length > 0) {
                  ExportConsumersDataToExcel(consumers, institution.fullLegalName);
                } else {
                  toast.error("No consumer data to export");
                }
              }}
